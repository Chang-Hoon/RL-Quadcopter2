...
class Actor:
    ...
    def __init__(self, state_size, action_size, action_low, action_high, num_units=4):
...
class Critic:
    ...
    def __init__(self, state_size, action_size, num_units=4):
        """Initialize parameters and build model.
...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.tau = 0.005 #0.001  # for soft update of target parameters
    ...
    def step(self, action, reward, next_state, done):
        ...
        self.memory.add(self.last_state, action[0], reward, next_state, done)
    ...
    def act(self, states):
        ...
        # action = np.clip(action.flatten(), self.task.action_low, self.task.action_high)  # flatten, clamp to action space limits
        # return list(action)
        # if action > self.task.action_high:
        #     action = self.task.action_high
        # if action < self.task.action_low:
        #     action = self.task.action_low
        # return list(action)
